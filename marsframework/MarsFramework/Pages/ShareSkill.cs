...
namespace MarsFramework.Pages
{
    internal class ShareSkill
    {
        ...
        public bool ValidateShareSkill(IWebDriver driver)
        {
            ...
            if (CategoryInTable.Text == ExcelLib.ReadData(2, "Category"))
            {

                if (TitleInTable.Text == ExcelLib.ReadData(2, "Title"))
                {
                    if (DescriptionInTable.Text == ExcelLib.ReadData(2, "Description"))
                        return true;
                    else
                        return false;
                }
